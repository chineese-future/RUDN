...
![Записываем и оформляем цель и задание лабораторной работы](image1/image1.png){ #fig:001 width=70% }
...
![Оформление хода работы](image1/image2.png){ #fig:002 width=70% }

## Выполнение лабораторной работы

По алгоритму выполняем лабораторную работу №2 в Markdown (рис. -@fig:003).

![Выполнение лабораторной работы](image1/image3.png){ #fig:003 width=70% }
...
![Отчет в docx и pdf](image1/image4.png){ #fig:004 width=70% }
