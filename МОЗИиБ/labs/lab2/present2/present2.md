...
- Сначала я написал функцию выбора алфавита.

![Выбор алфавита](image1/image1.png){ width=70% }

## Реализация шифра Вижинера

- Далее реализован шифр Вижинера.

![Генерация ключа и шифрование Вижинером](image1/image2.png){ width=70% }
![Расшифрование Вижинером](image1/image3.png){ width=70% }

## Выполнение шифрования маршрутным шифром

- Дaлее выполненил шифрование маршрутным шифром.

![Шифрование маршрутным](image1/image4.png){ width=70% }

## Выполнение дешифровки маршрутным шифром

- Далее выполнил дешифровку маршрутным шифром.

![Дешифровка маршрутным](image1/image5.png){ width=70% }

## Шифрование решёткой

- Далее я выполнил шифрование решёткой.

![Шифр решётки](image1/image6.png){ width=70% }

## Выполнение основной части программы (взаимодействия с пользователем)

- Далее выполнил функциональную часть взаимодействия с пользователем

![Взаимодействие с пользователем](image1/image7.png){ width=70% }

## Проверка работоспособности шифра Вижинера

- Далее выполнил проверку работоспособности шифра Вижинера.

![Проверка метода шифра Вижинера](image1/image8.png){ width=70% }

## Проверка работоспособности маршрутного шифра

- В конце проверил работоспособность маршрутного шифра
