...
![Функция шифр Цезаря на языке Python](image1/image1.PNG){ width=70% }

2) Далее реализована функция взаимодействия с пользователем: ввод языка, сдвига и сообщения для шифровки. И реализован запуск шифра Цезаря.

![Функция взаимодействия с пользователем](image1/image2.PNG){ width=70% }

3) Проверка работоспособности кода:

![Проверка работоспособности](image1/image3.PNG){ width=70% }
...
5) Далее реализована функция консольного взаимодействия с пользователем (ввод языка и текста) и запуск шифра:

![Функция взаимодействия с пользователем для шифра Атбаш](image1/image5.PNG){ width=70% }

6) Проверка работоспособности шифра Атбаша:

![Проверка метода шифра Атбаш](image1/image6.PNG){ width=70% }

Полный код в https://colab.google:
(https://colab.research.google.com/drive/1SPlyX35sVhPdizVTMSHkOYhYEe9IOt6e?authuser=0#scrollTo=2P1j_7wIanEe)
